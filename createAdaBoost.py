...
#Description: This script creates Ada Boost model of an encoded Variant file having SNPs and/or DIPs
...
#Example: python3 createAdaBoost.py NullMafMultiColDIPsScoredEncoded.txt test.fam 5 
...
clf=AdaBoostClassifier() #Using Newton-CG solver in the logistic Regression
...
#plt.show()
plt.savefig('ConfusionAdaBoost.png', bbox_inches='tight')
print("The Confusion Matrix is plotted as ConfusionAdaBoost.png")
...
#plt.show()
plt.savefig('ROCCurveAdaBoost.png', bbox_inches='tight')
print("The ROC Curve is plotted as ROCCurveAdaBoost.png")
plt.clf() #clear the figure
plt.cla() #clear the axes
...
plt.legend(loc = 'best')
#plt.show()
plt.savefig('PRCurveAdaBoost.png', bbox_inches='tight')
print("The Precision Recall curve plotted as PRCurveAdaBoost.png")
plt.close()

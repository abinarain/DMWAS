...
#Description: This script creates Bagging model of an encoded Variant file having SNPs and/or DIPs
...
clf=BaggingClassifier() #Using Newton-CG solver in the logistic Regression
...
#plt.show()
plt.savefig('ConfusionBagging.png', bbox_inches='tight')
print("The Confusion Matrix is plotted as ConfusionBagging.png")
...
#plt.show()
plt.savefig('ROCCurveBagging.png', bbox_inches='tight')
print("The ROC Curve is plotted as ROCCurveBagging.png")
plt.clf() #clear the figure
plt.cla() #clear the axes
...
#print(my_df.head())
my_df.to_csv('PDValuesBagging.csv', index=False)
#a.sort(axis=0)
#np.savetxt('columgSig.csv', listt, delimiter=',')  
print("Columns Significance Saved to PDValuesBagging.csv")
...
plt.legend(loc = 'best')
#plt.show()
plt.savefig('PRCurveBagging.png', bbox_inches='tight')
print("The Precision Recall curve plotted as PRCurveBagging.png")
plt.close()
